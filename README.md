...
This **Cash Agent** is an AI-powered treasury management tool designed to help businesses optimize their idle cash. Using the Claude Sonnet 4.6 model, the agent analyzes liquidity, forecasts cash flow, and recommends high-yield allocations across investment products.
